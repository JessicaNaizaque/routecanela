...
const VIDEO_POSTER = 'https://www.routecanela.de/assets/images/Mapa-Berlin-web-routecanela.jpg';

const MAP_PDF_BY_LANG: Record<Lang, string> = {
  DE: 'https://www.routecanela.de/assets/pdfs/Mapa-routecanela-web-GeR.pdf',
  EN: 'https://www.routecanela.de/assets/pdfs/Mapa-routecanela-web-EnG.pdf',
  ES: 'https://www.routecanela.de/assets/pdfs/Mapa-routecanela-web-EsP.pdf',
};
